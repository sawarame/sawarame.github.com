...
<small style={{ display: 'block', marginTop: '-1rem', color: 'var(--ifm-color-emphasis-600)' }}>試しにAIにこの記事の誤字脱字確認を依頼したところ、サブエージェントから読み込みの許可を求められ、</small>
...
<small style={{ display: 'block', marginTop: '-1rem', color: 'var(--ifm-color-emphasis-600)' }}>許可をして完了した頃にメインのAIに結果が届いた</small>
