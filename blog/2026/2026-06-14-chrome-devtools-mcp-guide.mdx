...
3. 一番下の「Build With Google Plugins」セクションの「Cutomize」ボタンをクリック
...
試しにこのサイトで実施前後の結果をLightHouseで計測してみました。スマホは、パフォーマンスが81から87まで改善し、PCは、パフォーマンスが97から99まで改善しました。

<BlogImageWrapper caption="改善前のLightHouseの結果画：スマホ">
  ![改善前のLightHouseの結果画：スマホ](images/chrome-devtools-mcp-guide_003.webp)
</BlogImageWrapper>

<BlogImageWrapper caption="改善後のLightHouseの結果画：スマホ">
  ![改善後のLightHouseの結果画：スマホ](images/chrome-devtools-mcp-guide_005.webp)
</BlogImageWrapper>

<BlogImageWrapper caption="改善前のLightHouseの結果画：PC">
  ![改善前のLightHouseの結果画：PC](images/chrome-devtools-mcp-guide_004.webp)
</BlogImageWrapper>

<BlogImageWrapper caption="改善後のLightHouseの結果画：PC">
  ![改善後のLightHouseの結果画：PC](images/chrome-devtools-mcp-guide_006.webp)
</BlogImageWrapper>
